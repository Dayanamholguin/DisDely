      ...
      @enderror
        ...
        <div class="col-md-12 col-sm-12 ">
            <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email"
                required value="{{$usuario->email }}" placeholder="Ingrese su email">
            @error('email')
            <div class="alert alert-danger" role="alert">
                {{$message}}
            </div>
        ...
        <div class="col-md-6 col-sm-12 mt-3">
            <input type="text" class="form-control" value="{{$usuario->celular }}"
                class="form-control @error('celular') is-invalid @enderror" name="celular" required minlength="7"
                maxlength="10" placeholder="Ingrese su celular">
            @error('celular')
            <div class="alert alert-danger" role="alert">
                {{$message}}
            </div>
        ...
        <div class="col-md-6 col-sm-12 mt-3">
            <input type="text" class="form-control" value="{{$usuario->celularAlternativo }}"
                class="form-control @error('celularAlternativo') is-invalid @enderror" name="celularAlternativo"
                required minlength="7" maxlength="10" placeholder="Ingrese su celular alternativo">
