    ...
    <div class="row container">
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
                <label for="">Contraseña actual<b style="color:red;">*</b></label>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
                <label for="">Nueva contraseña<b style="color:red;">*</b></label>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
                <label for="">Confirmar nueva contraseña<b style="color:red;">*</b></label>
