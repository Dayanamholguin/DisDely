            ...
            <div class="row mt-3">
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        <label for="">Seleccione cómo quiere el cliente para realizar el pedido<b style="color: red"
                                data-toggle="tooltip" data-placement="top" title="Requerido"> *</b></label>
                        <select name="cliente" class="form-control @error('cliente') is-invalid @enderror"
                            onchange="mostrarUsuarios(this.value);">
                            <option value="">Seleccione</option>
                            <option value="1" {{old('cliente' ) == 1 ? 'selected' : ''}}>Cliente genérico</option>
                            <option value="2" {{old('cliente' ) == 2 ? 'selected' : ''}}>Cliente registrado en el
                                sistema</option>
                        </select>
                        @error('cliente')
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        <label for="">Seleccione cómo quiere hacer el pedido<b style="color: red" data-toggle="tooltip"
                                data-placement="top" title="Requerido"> *</b></label>
                        <select name="producto" class="form-control @error('producto') is-invalid @enderror">
                            <option value="">Seleccione</option>
                            <option value="1" {{old('producto' ) == 1 ? 'selected' : ''}}>Producto personalizado
                            </option>
                            <option value="2" {{old('producto' ) == 2 ? 'selected' : ''}}>Producto registrado en el
                                sistema</option>
                        </select>
                        @error('producto')
                        <div class="alert alert-danger" role="alert">
                ...
                <div class="col-md-12 col-sm-12" id="clientes" style="display: none;">
                    <div class="form-group">
                        <label for="">Seleccione el usuario al cual le hará el pedido<b style="color: red"
                                data-toggle="tooltip" data-placement="top" title="Requerido"> *</b></label>
                        <select name="todosClientes" id="todosClientes"
                            class="form-control @error('todosClientes') is-invalid @enderror">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="form-group">
                    ...
                    <select name="producto" class="form-control @error('producto') is-invalid @enderror">
                        ...
                        <option value="2" {{old('producto' ) == 2 ? 'selected' : ''}}>Producto registrado en el sistema
                        </option>
                    </select>
                    @error('producto')
                    <div class="alert alert-danger" role="alert">
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                res.forEach(function(cliente) {
                    clientes.append($("<option>", {
                        value: cliente.id,
                        text: cliente.nombre + " " + cliente.apellido + " - " + cliente
                            .email
                    }));
                });
            },
