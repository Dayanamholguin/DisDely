        ...
        <div class="row portfolio-container product-list" id="product-list" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app product">
                ...
                <div class="portfolio-info">
                    ...
                    <a href="/pedido/crear/{{$producto->id}}/{{$cliente->id}}" class=" details-link" data-toggle="tooltip" data-placement="top" title="Clic para realizar el pedido"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAAAXNSR0IArs4c6QAAAFxJREFUSEtjZKAxYKSx+QyjFhAMYZKC6P////9BJjIyMhKtj2iFIINHLSAYYUMniGAuJeglNAXYUhfWVERzC3C5fOjEwagPkENgcJVFpOYLcMlLjiZS9IxaQDC0AFaEOBlExtG1AAAAAElFTkSuQmCC" /></a>
