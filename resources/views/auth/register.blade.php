                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <label for="nombre"><b>Nombre</b><b style="color: red"> *</b></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <label for="apellido"><b>Apellido</b><b style="color: red"> *</b></label>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <label for="email"><b>Correo</b><b style="color: red"> *</b></label>
