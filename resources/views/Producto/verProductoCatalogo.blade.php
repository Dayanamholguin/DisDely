    ...
    <div class="row">
        <div class="col-md-4 border-right">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    ...
                    <img src="/imagenes/{{$producto->img}}" alt="Admin" class="rounded-circle mt-5" width="130">
                    <div class="mt-3">
        ...
        <div class="col-md-8 mt-3">
            ...
            <div class="centrado mb-3">
                ...
                <a href="/cotizacion/crear/{{ $producto->id}}" class="btn btn-primary tipoletra">Añadir al catálogo</a>   
            </div>
        </div>
    </div>
</div>
